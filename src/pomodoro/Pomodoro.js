...
function Pomodoro() {
  ...
  function focusSessionExpired() {
    new Audio(`https://bigsoundbank.com/UPLOAD/mp3/1922.mp3`).play(); // plays buzzer sound
  ...
  function breakSessionExpired() {
    new Audio(`https://bigsoundbank.com/UPLOAD/mp3/1928.mp3`).play(); // plays ding ding ding sound
